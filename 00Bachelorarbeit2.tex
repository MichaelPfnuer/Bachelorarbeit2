...
\newcommand{\Title}{M\"oglichkeiten des Monitorings durch Einbindung von Single Board Computer in ein bestehendes Fertigungsumfeld}
\newcommand{\Keywords}{I$^2$C, 1-Wire, SBC, RRDtool, Raspberry Pi}
